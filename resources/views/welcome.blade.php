    ...
    <div class="row justify-content-center">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img class="d-block w-100" style="max-height: 500px;"  src="{{ asset('img/carousel/2015.jpg') }}" alt="First slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100" style="max-height: 500px;"  src="{{ asset('img/carousel/2016.jpg') }}" alt="Second slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100"  style="max-height: 500px;" src="{{ asset('img/carousel/2017.jpg') }}" alt="third slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100"  style="max-height: 500px;" src="{{ asset('img/carousel/2018.jpg') }}" alt="forth slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100"  style="max-height: 500px;" src="{{ asset('img/carousel/2019.jpg') }}" alt="fiveth slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100"  style="max-height: 500px;" src="{{ asset('img/carousel/1_pro.jpg') }}" alt="sixth slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100"  style="max-height: 500px;" src="{{ asset('img/carousel/2_pro.jpg') }}" alt="seventh slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100"  style="max-height: 500px;" src="{{ asset('img/carousel/3_pro.jpg') }}" alt="eighth slide">
                          </div>
                        </div>
        ...
        <div class="col-md-12  mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    <p>‘বাংলাদেশ ক্যাডেট একাডেমি’ মানসম্পন্ন শিক্ষা বিস্তার, শিক্ষার্থীদের মেধার বিকাশ এবং প্রকৃত মেধা ও অর্জিত জ্ঞানের যথার্থ মূল্যায়নে বদ্ধ পরিকর। এ পরিপ্রেক্ষিতে সামাজিক দায়বদ্ধতা থেকে প্রতি বছরই আয়োজন করে থাকি একটি অলাভজনক উদ্যোগ ‘BCA বৃত্তি পরীক্ষা’। শুরু থেকেই সুনিয়ন্ত্রিত ও সুবিন্যস্ত কর্মপরিকল্পনা অনুযায়ী বৃত্তি পরীক্ষা আয়োজন ও সংবর্ধনা প্রদান উদযাপিত হয়ে আসছে। এ প্রতিযোগিতায় অংশগ্রহণের মাধ্যমে একজন ার্থীর ওপর নিম্নলিখিত ইতিবাচক প্রভাব প্রতীয়মান হয়ঃ
                    </p>
                    <ul>
                        ...
                        <li>বৃত্তিপ্রাপ্ত হয়ে সংবর্ধনা অনুষ্ঠানে লাভ করা উৎসাহ শিক্ষার্থীদের অগ্রযাত্রাকে ত্বরান্বিত করে। সার্বিক বিবেচনায় আমি বিশ্বাস করি, এ প্রতিযোগিতায় অংশগ্রহণ থেকে একজন প্রতিযোগীকে বিরত না রেখে পরীক্ষায় অংশগ্রহণের সুযোগ প্রদান করা অধিকতর সমীচীন।</li>
                    </ul>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul>
                        ...
                        <li>পরীক্ষার্থীর পাসপোর্ট সাইজ ছবি স্ক্যান কপি আপলোড করতে হবে।  <span class="text-danger">(300*300 pixel,
Maximum 100kb)</span></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card-header text-info"><strong>{{ __('*প্রশ্নের ধরণঃ ') }}</strong></div> 
                     ...
                     <ul>
                         <li class="p-2">১১ ডিসেম্বর ২০২০, শুক্রবার, সকাল ১০ টা। </li>
                     </ul>
                     ...
                     <ul>
                         ...
                         <li>পরীক্ষার্থীর রোল নং হবে ছাত্র/ছাত্রীর ইউজার আইডি এবং মাতার মোবাইল নং হবে পাসওয়ার্ড।  </li>
                         <li>www.bcabritti.com ওয়েব সাইটে প্রবেশ করে Exam এ ক্লিক করে প্রত্যেকের আইডি পাসওয়ার্ড ব্যবহার করে এক্সাম দিতে হবে।  </li>
                         <li>৪ অক্টোবর ও ৪ ডিসেম্বর ২০২০ সকাল ১০ ঘটিকায় ডেমো এক্সাম নেয়া হবে। </li>
                     </ul>
