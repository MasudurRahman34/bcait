                        ...
                        @if (Auth::User()->is_admin==0)
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('exam.index') }}">
                                       
                                        {{ __('Class Exam') }}
                                    </a>
                                    <a class="dropdown-item" href="{{ route('demo.exam.index') }}">
                                        {{ __('Demo Exam') }}
                                    </a>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('student.result',[Auth::User()->id]) }}">{{ __('Result') }}</a>
                            </li>
